        ...
        <section className="w-[100%]">
            ...
            <section className="flex justify-center my-[5rem] px-[20%]">
                <div className="flex flex-col md:flex-row gap-[2rem]">
                    ...
                    <nav className="bg-[#162A41] h-[5%] w-[8%] flex flex-row p-[0.6rem] absolute bottom-[2rem]">
                    ...
                    <aside className="flex flex-col w-[40%]">
                        <section className="bg-[#EEF7FF] p-[1rem] rounded-[2px] w-[100%] h-[9.5rem]">
                        ...
                        <section className="bg-[#162A41] text-white flex flex-col justify-center items-center text-center p-[2rem] py-[4.5rem] mt-[1rem]">
