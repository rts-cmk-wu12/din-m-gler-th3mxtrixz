...
export default function Ad() {
    return (
        <section className="bg-[#162A41] w-[100%] text-white flex justify-center items-center z-[5]">
            <div className="w-[38%]">
                ...
                <div className="flex w-[100%] items-center">
                    <Link href="http://play.google.com/store/apps">
                    ...
                    <Link href="https://apps.apple.com/dk/developer/apple/id284417353?see-all=i-phonei-pad-apps">
